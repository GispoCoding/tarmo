...
7. Migrate your local development database to the new revision by running `make test-migrate-db`, or just `make rebuild` and `make test-create-db` to start a new development instance.
