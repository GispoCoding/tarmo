    ...
    "features": [
        {
            ...
            "properties": {
                ...
                "LISATIEDOT1": None,
                "LISATIEDOT2": None,
                "infoFi": "Lamminpäässä kasvavat viisi kuusta on rauhoitettu juurineen.",
                "KOHTEENKUVAUS2": None,
                "name": "Lamminpään Kuusikorvenpuiston kuuset",
    ...
    "features": [
        {
            ...
            "properties": {
                "TUNNUS": 1,
                "name": "Metsälehmus - niinipuu",
                "RASTI": 1,
                "infoFi": "Niinipuun monet kasvot",
