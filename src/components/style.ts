export default {
  ...
  sources: {
    taustakartta: {
      type: "vector",
      url: `https://avoin-karttakuva.maanmittauslaitos.fi/vectortiles/tilejson/taustakartta/1.0.0/taustakartta/default/v20/WGS84_Pseudo-Mercator/tilejson.json?api-key=${process.env.API_KEY_NLS}`,
    },
  },
  glyphs: `https://avoin-karttakuva.maanmittauslaitos.fi/vectortiles/glyphs/{fontstack}/{range}.pbf?api-key=${process.env.API_KEY_NLS}"`,
  layers: [
    {
      id: "background",
      type: "background",
    ...
    },
    {
      ...
      "filter": [
        ...
        ["get", "kohdeluokka"],
        [
          35300, 35411, 35412, 35421, 35422, 38300, 38700, 39110, 39120, 39130,
          33000, 38400, 38600, 35401, 35402,
        ],
        true,
        false,
      ],
      "layout": { visibility: "visible" },
      "paint": { "fill-color": "rgba(227, 232, 227, 1)" },
    },
    {
      "id": "maankaytto",
      "type": "fill",
    ...
    },
    {
      ...
      "paint": { "line-color": "rgba(208, 208, 208, 1)", "line-width": 0.5 },
    },
    {
      "id": "lautta ja lossi",
      "type": "line",
    ...
    },
    {
      ...
      "filter": [
        "all",
        ["==", ["geometry-type"], "LineString"],
        ["match", ["get", "kohdeluokka"], [16511, 16512], true, false],
      ],
      "layout": {},
      "paint": {
        "line-color": "rgba(164, 182, 183, 1)",
        "line-dasharray": [6, 8],
        "line-width": [
          "interpolate",
          ["exponential", 1.55],
    ...
    },
    {
      ...
      "paint": { "fill-color": "rgba(199, 215, 216, 1)" },
    },
    {
      "id": "vesisto_viiva",
      "type": "line",
    ...
    {
      "id": "rakennettu-ymparisto lentokentta_alue",
      "type": "fill",
      "source": "taustakartta",
      "source-layer": "liikenne",
      "filter": [
        ...
        [
          ...
          ["get", "kohdeluokka"],
          [
            32411, 32412, 32413, 32414, 32415, 32416, 32417, 32418, 32441,
            32442,
          ],
          true,
          false,
    ...
    {
      "id": "rakennettu-ymparisto rakennus",
      "type": "fill",
      "source": "taustakartta",
    ...
    {
      "id": "rakennettu-ymparisto rakennelmat",
      "type": "line",
      "source": "taustakartta",
    ...
    },
    {
      ...
      "filter": [
        ...
        [
          ...
          ["get", "kohdeluokka"],
          [
            12141, 12132, 12131, 12122, 12121, 12112, 12111, 12313, 12314,
            12136,
          ],
          true,
          false,
    ...
    },
    {
      ...
      "layout": { visibility: "none" },
      "paint": { "line-color": "hsl(0,0%,65%)", "line-width": 1 },
    },
  ],
  id: "NLS-Basemap",
};
